...
class Euler_Maruyama(nn.Module):
    """Module to do Euler-Maruyama integration"""
    ...
    def forward(self, initial_state, control_inputs, sigma):
        """
        ...
        if batch_mode:
            ...
            state = initial_state + diff * self.timestep + sigma
            ...
            for i in range(1, control_inputs.shape[1]):
                ...
                state = integrated_states[-1] + diff * self.timestep + sigma
                integrated_states.append(state)
